 ...
 */
public class MyHtmlTable extends MyPageObject {
    private final WebElement tableElement;
    private List<String> headings;

    public MyHtmlTable(final WebElement tableElement) {
        this.tableElement = tableElement;
        this.headings = null;
    }

    public MyHtmlTable(final WebElement tableElement, List<String> headings) {
        this.tableElement = tableElement;
        this.headings = headings;
    }

    public static MyHtmlTable inTable(final WebElement table) {
        return new MyHtmlTable(table);
    }
    ...
    public static class RUHtmlTableBuilder {
        ...
        public List<Map<Object, String>> readRowsFrom(WebElement table) {
            return new MyHtmlTable(table, headings).getRows();
        }

        public MyHtmlTable inTable(WebElement table) {
            return new MyHtmlTable(table, headings);
        }
    }
...
//        return cells.get(column).getText();
        return getText(cells.get(column));
    }
...
//                return from.getText();
    ...
    public static List<Map<Object, String>> rowsFrom(final WebElement table) {
        return new MyHtmlTable(table).getRows();
    }

    public static List<WebElement> filterRows(final WebElement table, final BeanMatcher... matchers) {
        return new MyHtmlTable(table).getRowElementsWhere(matchers);
    }

    public List<WebElement> filterRows(final BeanMatcher... matchers) {
        return new MyHtmlTable(tableElement).getRowElementsWhere(matchers);
    }
