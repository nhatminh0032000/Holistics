...
private final Workbook wb;
    ...
    public static ToHtmlConverter create(Workbook wb, Appendable output) {
        return new ToHtmlConverter(wb, output);
    }


    public static ToHtmlConverter create(String path, Appendable output)
            throws IOException {
        return create(new FileInputStream(path), output);
    }


    public static ToHtmlConverter create(InputStream in, Appendable output)
            throws IOException {
        try {
    ...
    private ToHtmlConverter(Workbook wb, Appendable output) {
        if (wb == null)
    ...
    public static void main(String[] args) throws Exception {
        ...
        ToHtmlConverter toHtml = create(args[0], new PrintWriter(new FileWriter(args[1])));
    ...
    public void printStyles() {
        ...
        try {
            in = new BufferedReader(new InputStreamReader(
                    ClassLoader.getSystemClassLoader().getResourceAsStream("excelStyle.css")));
            String line;
