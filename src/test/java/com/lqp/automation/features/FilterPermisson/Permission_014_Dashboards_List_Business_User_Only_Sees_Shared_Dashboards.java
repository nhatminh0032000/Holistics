...
public class Permission_014_Dashboards_List_Business_User_Only_Sees_Shared_Dashboards {
    @Managed
    WebDriver driver;
    ...
    @Test
    public void Permission_014_Dashboards_List_Business_User_Only_Sees_Shared_Dashboards(){
        ...
        filterPermission.dashboardList_BusinessUserPermission();
    }
    @After
