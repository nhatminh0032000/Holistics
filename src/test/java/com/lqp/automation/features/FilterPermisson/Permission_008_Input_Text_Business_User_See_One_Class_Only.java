...
public class Permission_008_Input_Text_Business_User_See_One_Class_Only {
    @Managed
    WebDriver driver;
    ...
    @Test
    public void Permission_008_Input_Text_Business_User_See_One_Class_Only(){
        ...
        filterPermission.businessUserOnlySeesOneClass();
    }
    @After
