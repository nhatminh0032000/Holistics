...
public class Permission_013_Dashboards_List_Admin_See_All_Available_Dashboards {
    @Managed
    WebDriver driver;
    ...
    @Test
    public void Permission_013_Dashboards_List_Admin_See_All_Available_Dashboards(){
        filterPermission.shouldAbleToLogin();
        filterPermission.openLeftNav();
        filterPermission.openDashboardPage();
        filterPermission.dashboardList_AdminPermission();
    }
    @After
