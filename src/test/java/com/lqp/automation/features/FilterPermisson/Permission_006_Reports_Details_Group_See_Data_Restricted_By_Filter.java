...
public class Permission_006_Reports_Details_Group_See_Data_Restricted_By_Filter {
    @Managed
    WebDriver driver;
    ...
    @Test
    public void Permission_006_Reports_Details_Group_See_Data_Restricted_By_Filter(){
        ...
        filterPermission.groupSeesRestrictedOptions();
    }
    @After
