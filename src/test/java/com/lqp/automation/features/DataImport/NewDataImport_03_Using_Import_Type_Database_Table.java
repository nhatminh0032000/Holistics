...
public class NewDataImport_03_Using_Import_Type_Database_Table {
    @Managed
    WebDriver driver;
    @Steps
    ...
    String sourceTypeSelection ="Database Table";

    @Test
    public void NewDataImport_03_Using_Import_Type_Database_Table(){
