...
public class NewDataTransform_001_Can_Create_Data_Transform_With_Transformation_Type_As_Materialized_Full {
    @Managed
    WebDriver driver;
    @Steps
    ...
    String sourceTypeSelection ="Materialized (Full)";
    String dataTransformName="Auto Materialized Full";
    @Test
