...
public class NewSharedfilter_017_DateType_Set_Minimum_Date_And_From_Data_Source {
    @Managed
    WebDriver driver;
    @Steps
    ...
    @Test
    public void NewSharedfilter_017_DateType_Set_Minimum_Date_And_From_Data_Source(){
        String filterType = "Date";
        String sharedFilterName ="Auto Start Date";
        String message ="Shared Filter added successfully";
        String userName = "minhthuan0032000@gmail.com";
        String pwd="thuanthuan";
        ...
        step_TC.setMinimumDateDataSource();
