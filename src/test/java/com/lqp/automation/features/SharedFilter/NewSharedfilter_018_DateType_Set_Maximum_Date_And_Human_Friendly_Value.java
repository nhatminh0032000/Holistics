 ...
 * Step 5: Click "Set Maximum date [?]  " checkbox
 * Step 6: Select "Human friendly value" in dropdown
 * Step 7: Enter "10 days ago" into text field
...
public class NewSharedfilter_018_DateType_Set_Maximum_Date_And_Human_Friendly_Value {
    @Managed
    WebDriver driver;
    @Steps
    ...
    @Test
    public void NewSharedfilter_018_DateType_Set_Maximum_Date_And_Human_Friendly_Value(){
        ...
        step_TC.setMaximumDate_Human_Friendly_Value();
