...
public class NewSharedfilter_014_DateType_Verify_Enter_Help_Contains_Text {
    @Managed
    WebDriver driver;
    @Steps
    ...
    @Test
    public void Newsharedfilter014_VerifyEnterHelpContainsText(){
        ...
        endUser.enterHelptext(helpText);
