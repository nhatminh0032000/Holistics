...
public class Dashboard_029_Delete_Dashdoard {
    @Managed
    WebDriver driver;
    @Steps
    Dashboard dashboard;
    ...
    @Test
    public void Dashboard_018_Report_Can_Be_Added_To_Dashboard_Successfully(){
        dashboard.shouldAbleToLogin();
        dashboard.openLeftNav();
        dashboard.openDashboardPage();
        dashboard.deleteAllRowsSameName("AutoDashboard");
    }
    @After
